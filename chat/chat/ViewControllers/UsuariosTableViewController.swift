...
class UsuariosTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        usuarios.observe(DataEventType.childAdded) { chats in
             
            let dados = chats.value as? NSDictionary
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let database = Database.database().reference()
        let usuarios = database.child("usuarios")
        let chats = usuarios.child(idUsuarioSelecionado).child("chats")
        ...
        if let idUsuarioLogado = autenticacao.currentUser?.uid {
            ...
            usuarioLogado.observeSingleEvent(of: DataEventType.value) { chatsshot in
                ...
                chats.childByAutoId().setValue(chatt)
